...
const en: Record<string, string> = {
  ...
  groupBulkTip: 'Check or uncheck every row this group lists (respects the filter)',
  ...
  cancel: 'Cancel',
  panelFooter: 'Checked refs keep their lanes on the canvas. Hover a row for "only this"; Archived/Dormant rows toggle lane visibility.',
...
const zh: Record<string, string> = {
  ...
  groupBulkTip: '勾选/取消本组当前列出的所有行（跟随过滤）',
  ...
  jumpToHead: '跳转到 HEAD',
  cancel: '取消',
  panelFooter: '勾选的引用保留在画布上；悬停行尾可"只看此引用"；归档/休眠行控制泳道可见性。',
