...
const en: Record<string, string> = {
  ...
  locatePlaceholder: 'Jump to hash / branch…',
  locateNoResults: 'No match in the loaded range',
  locateScopeHint: 'Searches loaded history only',
...
const zh: Record<string, string> = {
  ...
  fitTip: '将整个图形缩放到视野内',
  filterRefs: '筛选分支/标签…',
  locatePlaceholder: '跳转到 hash / 分支名…',
  locateNoResults: '已加载范围内无匹配',
  locateScopeHint: '仅搜索当前已加载的历史',
